...
object ConfigManager {
  ...
  object PostgreSqlConfig extends ConfigManager(Some("settings.postgresql"))

  object KafkaConfig extends ConfigManager(Some("settings.kafka"))

  object SparkConfig extends ConfigManager(Some("settings.spark"))

  object UserConfig extends ConfigManager(Some("settings.user"))
